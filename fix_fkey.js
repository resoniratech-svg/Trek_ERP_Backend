...
p.query(`
ALTER TABLE expense_allocations DROP CONSTRAINT expense_allocations_expense_id_fkey;
...
`).then(() => console.log('Fixed FK constraint')).catch(console.error).finally(()=>p.end());
